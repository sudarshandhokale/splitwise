module DeviseTokenAuth
  class PasswordsController < DeviseTokenAuth::ApplicationController
    ...
    def render_create_error_missing_email
      render json: unauthorize_error(
        I18n.t("devise_token_auth.passwords.missing_email")), status: 401
    end

    def render_create_error_missing_redirect_url
      render json: unauthorize_error(
        I18n.t("devise_token_auth.passwords.missing_redirect_url")), status: 401
    end
    ...
    def render_create_success
      render json: success(@resource,
        I18n.t("devise_token_auth.passwords.sended", email: @email)), status: :ok
    end

    def render_create_error
      render json: unauthorize_error(@errors[0]), status: 401
    end
    ...
    def render_update_error_unauthorized
      render json: unauthorize_error, status: 401
    end
    ...
    def render_update_success
      render json: success(@resource,
        I18n.t("devise_token_auth.passwords.successfully_updated")), status: :ok
    end

    def render_update_error
      return render json: error(@resource), status: 422
    end
